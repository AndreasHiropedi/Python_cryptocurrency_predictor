# Python cryptocurrency predictor
...
Note: due to the high volume of data, we set the starting point to 01/01/2024 (Jaunary 1st 2024), and we only consider data from this point up until the current date. 
